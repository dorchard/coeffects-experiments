...
>     czip (StackN x d, StackN y c) = StackN (x, y)  (c + d) --(c `min` d) --

> instance CUnzip StackN where
>     cunzip (StackN (x, y) r) = --if ((r + 1) > 7) then error "Stack overflow"
>                                (StackN x 1, StackN y r)

 --if (r + 1) > 10 then error "StackN overflow" else                            

-- increment stackN counter
